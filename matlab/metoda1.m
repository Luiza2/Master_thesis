...
%34401A
clear all;
R_wz = [942.25, 975.54, 988.65, 1000.8, 1039.8, 1069.2, 1100.1, 1159.8, 1200, 1230.9, 1250, 1300.4, 1330.07];

addpath('D:\Studia wszystko\Studia 5\sem 3\praca magisterska\pomiary\Metoda1');

liczba_rezystorow = 13;
%pobranie danych z mk
%format: rezystancja

Metody = zeros(1024,liczba_rezystorow);
R950;  Metody(:,1)  = Metoda_1;
R976;  Metody(:,2)  = Metoda_1;
R988;  Metody(:,3)  = Metoda_1;
R1000; Metody(:,4)  = Metoda_1;
R1040; Metody(:,5)  = Metoda_1;
R1070; Metody(:,6)  = Metoda_1;
R1100; Metody(:,7)  = Metoda_1;
R1160; Metody(:,8)  = Metoda_1;
R1200; Metody(:,9)  = Metoda_1;
R1230; Metody(:,10) = Metoda_1;
R1250; Metody(:,11) = Metoda_1;
R1300; Metody(:,12) = Metoda_1;
R1330; Metody(:,13) = Metoda_1;

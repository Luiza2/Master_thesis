...
%34401A
clear all;
R_wz = [ 975.54, 988.65, 1000.8, 1039.8, 1069.2, 1100.1, 1159.8, 1200, 1230.9, 1250, 1300.4];


addpath('D:\Studia wszystko\Studia 5\sem 3\praca magisterska\pomiary\Metoda3');

liczba_rezystorow = 11;
%pobranie danych z mk
%format: rezystancja

Metody = zeros(1024,liczba_rezystorow);

R976;  Metody(:,1)  = Metoda_3;
R988;  Metody(:,2)  = Metoda_3;
R1000; Metody(:,3)  = Metoda_3;
R1040; Metody(:,4)  = Metoda_3;
R1070; Metody(:,5)  = Metoda_3;
R1100; Metody(:,6)  = Metoda_3;
R1160; Metody(:,7)  = Metoda_3;
R1200; Metody(:,8)  = Metoda_3;
R1230; Metody(:,9)  = Metoda_3;
R1250; Metody(:,10) = Metoda_3;
R1300; Metody(:,11) = Metoda_3;
